  ...
  return (
    <nav
        className={`fixed top-0 w-full z-50 ${
          navColour ? "bg-gray-800 bg-opacity-50 backdrop-blur-lg shadow-md" : "bg-transparent md:bg-gray-900 md:bg-opacity-50"
      ...
      >
        <div className="container mx-auto flex items-center justify-between py-4 px-6 md:px-10">
          ...
          <div
            className={`fixed inset-0  bg-opacity-90 transition-transform transform ${
          ...
          >
            ...
            <div className="flex flex-col items-center space-y-8 bg-black bg-opacity-80 backdrop-blur-lg md:bg-transparent md:flex-row md:space-y-0 md:space-x-8 mt-20 md:mt-0">
              {[
                ...
                <Link
                  key={index}
                  href={href}
                  className="text-white flex items-center space-x-2 hover:text-blue-300 transition-colors"
